...
/**
 * A simple extension of a regular linear activity_order_details_accepted that supports the divider API
 * of Android 4.0+. The dividers are added adjacent to the children by changing
 * their activity_order_details_accepted params. If you need to rely on the margins which fall in the
 * same orientation as the activity_order_details_accepted you should wrap the child in a simple
